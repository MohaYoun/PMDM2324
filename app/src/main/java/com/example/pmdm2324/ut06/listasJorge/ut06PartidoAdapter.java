...
public class ut06PartidoAdapter extends RecyclerView.Adapter<ut06PartidoAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            partido = (TextView) view.findViewById(R.id.u6ListaNombre);
            resultado = (TextView) view.findViewById(R.id.u6ListaResultado);
        }
     ...
     * by RecyclerView.
     */
    public ut06PartidoAdapter(ut06Partido[] dataSet) {
